...
var _listaNotas = __webpack_require__(8);
...
var _nota = __webpack_require__(9);
...
function criaInput(notaAtual, novaNota) {
...
function criaTextarea(notaAtual, novaNota) {
    var props = {
...
function FormNotas(props) {
    ...
    var novaNota = new _nota2.default(props.notaAtual.titulo, props.notaAtual.texto, props.notaAtual.editando);
    var formNotas = void 0;

    var inputTitulo = criaInput(props.notaAtual, novaNota);
    var textareaTexto = criaTextarea(props.notaAtual, novaNota);
    var form = criaForm(props);
